...
export default function ProfilePage() {
    ...
    return (
        ...
        >
            <div className="ss-card p-8 flex flex-col items-center text-center w-full max-w-md relative overflow-hidden">
                ...
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[var(--color-bg-base)] to-[var(--color-bg-panel)] border-2 border-[var(--color-accent-cyan)] flex items-center justify-center mb-6 shadow-xl relative group">
                    ...
                    {data ? (
                        <span className="text-3xl font-bold text-[var(--color-accent-cyan)]">{data.avatar}</span>
                    ) : (
                    ...
                    <div className="mb-8 w-full">
                        ...
                        <div className="flex justify-center gap-4 mt-4 py-4 border-t border-[var(--color-border-subtle)]">
                            <div className="text-center">
                                ...
                                <p className={`font-medium ${data?.plan === 'Pro' ? 'text-[var(--color-accent-purple)]' : 'text-[var(--color-text-primary)]'}`}>{data?.plan || 'Free'}</p>
                            </div>
